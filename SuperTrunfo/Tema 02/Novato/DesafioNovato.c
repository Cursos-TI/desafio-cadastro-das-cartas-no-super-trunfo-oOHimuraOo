    ...
    inicio: {
        ...
        finalizacao: {
            ...
            selecaoFinal: {
                ...
                scanf("%d", &verificador_final);

                //verifica qual foi a opção selecionada e apresenta o devido resultado se baseando nisso.
                switch (verificador_final)
                {
                case 1:
                    //função responsavel por limpar o console.
                    clear_console();
                    ...
                    if (vencedor_populacao == 1) {
                        ...
                        printf("A carta 01 (%s) tem %d habitantes.\n", nome_cidade1, populacao1);
                        printf("A carta 02 (%s) tem %d habitantes.\n", nome_cidade2, populacao2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!\n", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: POPULAÇÃO ***\n\n");
                        ...
                        printf("A carta 02 (%s) tem %d habitantes.\n", nome_cidade2, populacao2);
                        printf("A carta 01 (%s) tem %d habitantes.\n", nome_cidade1, populacao1);
                        printf("Com isso a carta vencedora foi a carta 2 (%s)!", nome_cidade2);
                    }
                    break;
                case 2:
                    ...
                    if (vencedor_area == 1) {
                        ...
                        printf("A carta 01 (%s) tem %d km².\n", nome_cidade1, area1);
                        printf("A carta 02 (%s) tem %d km².\n", nome_cidade2, area2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: ÁREA ***\n\n");
                        printf("A carta 02: %s, venceu!\n", nome_cidade2);
                        printf("Nessa categoria vence quem tem mais km².\n");
                ...
                case 3:
                    ...
                    if (vencedor_pib == 1) {
                        ...
                        printf("A carta 01 (%s) tem %d bilhões de reais.\n", nome_cidade1, pib1);
                        printf("A carta 02 (%s) tem %d bilhões de reais.\n", nome_cidade2, pib2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: PIB ***\n\n");
                        printf("A carta 02: %s, venceu!\n", nome_cidade2);
                ...
                case 5:
                    ...
                    if (vencedor_densidade == 1) {
                        printf("*** A CATEGORIA SELECIONADA FOI: DENSIDADE POPULACIONAL ***\n\n");
                        printf("A carta 01: %s, venceu!\n", nome_cidade1);
                        printf("Nessa categoria vence quem tem menos habitantes por km².\n");
                        printf("A carta 01 (%s) tem %d hab/km².\n", nome_cidade1, densidade1);
                        printf("A carta 02 (%s) tem %d hab/km².\n", nome_cidade2, densidade2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: DENSIDADE POPULACIONAL ***\n\n");
                        printf("A carta 02: %s, venceu!\n", nome_cidade2);
                ...
                case 6:
                    ...
                    if (vencedor_pibpc == 1) {
                        ...
                        printf("A carta 01 (%s) tem %d reais por habitante.\n", nome_cidade1, pibpc1);
                        printf("A carta 02 (%s) tem %d reais por habitante.\n", nome_cidade2, pibpc2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: PIB PER CAPTA ***\n\n");
                        printf("A carta 02: %s, venceu!\n", nome_cidade2);
                ...
                case 7:
                    ...
                    if (vencedor_super == 1) {
                        ...
                        printf("A carta 01 (%s) tem %d pontos.\n", nome_cidade1, super_poder1);
                        printf("A carta 02 (%s) tem %d pontos.\n", nome_cidade2, super_poder2);
                        printf("Com isso a carta vencedora foi a carta 1 (%s)!", nome_cidade1);
                    } else {
                        printf("*** A CATEGORIA SELECIONADA FOI: SUPER PODER ***\n\n");
                        printf("A carta 02: %s, venceu!\n", nome_cidade2);
                ...
                default:
                    clear_console();
                    printf("o valor inserido não foi reconhecido por favor insira um numero de 1 a 7 conforme mostrado anteriormente.\n");
                    pause_program();
                    goto selecaoFinal;
                }
            }
